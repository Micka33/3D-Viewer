...
@property(nonatomic) CC3Vector position;
@property(nonatomic) CC3Vector rotation;
@property(nonatomic) CGFloat num;
@property(nonatomic) CC3Vector initialRotation;
@property(nonatomic, strong) CC3Node *pivot;


- (pin_descriptor*) initWithName:(NSString*)name
