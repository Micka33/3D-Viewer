...
#import "_D_Viewer_2AppDelegate.h"
...
@implementation _D_Viewer_2AppDelegate {
	UIWindow* _window;
...
//	_viewController.isOverlayingDeviceCamera = YES;
	...
	CC3Layer* cc3Layer = [_D_Viewer_2Layer node];
	
	// Create the customized 3D scene and attach it to the layer.
	// Could also just create this inside the customer layer.
	cc3Layer.cc3Scene = [_D_Viewer_2Scene scene];
